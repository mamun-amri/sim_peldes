...
class Pengajuan_domisili extends CI_Controller
{
	...
	public function index()
	{
		...
		switch ($level) {
			case '0':
				...
				break;
			case '1': //rw
				$this->db->where("pengajuan", "domisili");
		...
		$data['title'] = "Kelola Data Pengajuan KK";
		$this->template->load('template', 'pengajuan_domisili/tbl_ktp_pengajuan_list', $data);
	}
	...
	public function cetak($id)
	{
		...
		$data = [
			...
			"judul" => "KARTU DOMISILI PENDUDUK",
			"judul2" => "Kartu Domisili Sementara",
		];
		...
		if ($row) {
			...
			switch ($level) {
				...
				Anda Bukan Staf Desa!
					...
					redirect(site_url('pengajuan_domisili'));
					break;
			}
	...
	public function tolak($id)
	{
		...
		$data = array(
			'button' => 'Create',
			'action' => site_url('pengajuan_domisili/tolak_action'),
			'id' => set_value('id', $id),
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			$this->template->load('template', 'pengajuan_domisili/tbl_ktp_pengajuan_read', $data);
		} else {
			$this->session->set_flashdata('message', 'Record Not Found');
			redirect(site_url('pengajuan_domisili'));
		}
	...
	public function create()
	{
		$data = array(
			'button' => 'Create',
			'action' => site_url('pengajuan_domisili/create_action'),
			'id' => set_value('id'),
			'nama' => set_value('nama'),
		...
		$this->template->load('template', 'pengajuan_domisili/tbl_ktp_pengajuan_form', $data);
	}
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('pengajuan_domisili/update_action'),
	...
	{
		$data['file'] = $id;
		$this->template->load('template', 'pengajuan_domisili/view', $data);
	}
	...
	public function word()
	{
		...
		$this->load->view('pengajuan_domisili/tbl_ktp_pengajuan_doc', $data);
	}
	...
	function pdf()
	{
		...
		$this->load->view('pengajuan_domisili/tbl_ktp_pengajuan_pdf', $data);
	}
}
