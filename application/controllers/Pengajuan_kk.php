...
class Pengajuan_kk extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->load('template', 'pengajuan_kk/tbl_ktp_pengajuan_list', $data);
	}
	...
	public function cetak($id)
	{
		...
		$data = [
			...
			"judul2" => "Kartu Keluarga Sementara",
		];
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			$this->template->load('template', 'pengajuan_kk/tbl_ktp_pengajuan_read', $data);
		} else {
			$this->session->set_flashdata('message', 'Record Not Found');
			redirect(site_url('pengajuan_kk'));
		}
	...
	public function create()
	{
		$data = array(
			'button' => 'Create',
			'action' => site_url('pengajuan_kk/create_action'),
			'id' => set_value('id'),
			'nama' => set_value('nama'),
		...
		$this->template->load('template', 'pengajuan_kk/tbl_ktp_pengajuan_form', $data);
	}
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('pengajuan_kk/update_action'),
	...
	{
		$data['file'] = $id;
		$this->template->load('template', 'pengajuan_kk/view', $data);
	}
	...
	public function word()
	{
		...
		$this->load->view('pengajuan_kk/tbl_ktp_pengajuan_doc', $data);
	}
	...
	function pdf()
	{
		...
		$this->load->view('pengajuan_kk/tbl_ktp_pengajuan_pdf', $data);
	}
}
